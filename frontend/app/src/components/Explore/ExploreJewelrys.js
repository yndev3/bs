...
const initData = {
    pre_heading: "Jewelrys Assets NFTs",
    heading: "Jewelrys",
    btn_1: "View All",
    btn_2: "Load More"
}
...
const data = [
    {
        id: "1",
        img: "/img/Jewelrys.jpg",
        title: "Necklaces & Pendants for Women",
        brand: "Tiffany",
        price: "1,000",
    },
    {
...
class ExploreJewelrys extends Component {
    state = {
        initData: {},
        data: []
    }
                ...
                <div className="container">
                    ...
                    <div className="row items">
                        {this.state.data.map((item, idx) => {
                            return (
                                <div key={`exo_${idx}`} className="mt-3 col-12 col-sm-6 col-lg-3 itemjewelry">
                                    <div className="card">
                    ...
                    <div className="row">
                        <div className="col-12 text-center">
                          <a id="load-btn-jewelry" className="btn btn-bordered-white mt-5" href="#">{this.state.initData.btn_2}</a>
                        </div>
                    </div>
                </div>
            </section>
...
export default ExploreJewelrys;