...
export default function Create() {
    ...
    const changeHandler = async (event) => {
        ...
        const result = await pinFolderToIPFS(selectedFile);
        console.log(result);
    };
                        ...
                        <form className="item-form card no-hover">
                            <div className="row">
                                <div className="col-12">
                                    <div className="input-group form-group">
                                        <div className="custom-file">
                                            {/*<input type="file" className="custom-file-input" id="inputGroupFile01" onChange={ changeHandler }/>*/}
                                            <input type="file" className="custom-file-input" id="inputGroupFile01" directory="" webkitdirectory="" onChange={ changeHandler }/>
                                ...
                                <div className="col-12 col-md-6">
                                    <div className="form-group">
                                        <input type="number" className="form-control" name="price" placeholder="Item Price" required="required" />
                                    </div>
                                </div>
                                ...
                                <div className="col-12">
                                    <button className="" onClick={submitHandler}>Create Item</button>
                                    {/*<button className="btn w-100 mt-3 mt-sm-4" onClick={submitHandler}>Create Item</button>*/}
                                </div>
                            </div>
                        </form>
                    </div>
