                ...
                <div className="container">
                    <div className="row">
                        <div className="col-12 col-md-6 col-lg-7 align-items-center">
                            <span className="mt-5">{this.state.data.pre_heading}</span>
                            <h1 className="mt-4">{this.state.data.heading}</h1>
                            <p className="f140">{this.state.data.content}</p>
                            {/* Buttons */}
                            <div className="button-group mt-5">
                                <a className="mr-4" href="/create"><i class="fab fa-twitter fa-3x"></i></a>
                                <a className="mr-4" href="/create"><i class="fab fa-discord fa-3x"></i></a>
                                <a className="mr-4" href="/create"><i class="fab fa-telegram fa-3x"></i></a>
                            </div>
                        </div>
